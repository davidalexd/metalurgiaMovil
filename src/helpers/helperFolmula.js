...
export const selectedFormula = (formulaIdentifier, values) => {
    let result = []

    switch (formulaIdentifier) {
        case 'con1Metal1':
            result = values ? con1meta1(values) : validationCon1meta1()
            break;
        case 'con2Metal2':
            result = values ? con2meta2(values) : validationCon2meta2()
            break;
...
const con1meta1 = (values) => {
    ...
    const resultArray = [
        { title: `Concentrado ${metal} (T/h)`, value: concentrated },
        { title: 'Relave (T/h)', value: tailings },
        { title: `%Recup. ${metal}`, value: recovery },
        { title: 'Ratio Concentración', value: concentrationRatio },
    ];
    return resultArray
}
...
const con2meta2 = (values) => {
    const {
        con2Metal2f: f,
        con2Metal2conversion: conversion,
    ...
    const resultArray = [
        { title: `Concentrado ${metal1} (T/h)`, value: concentratedMetal1 },
        { title: `Concentrado ${metal2} (T/h)`, value: concentratedMetal2 },
        { title: 'Relave (T/h)', value: tailings },
        { title: `%Recup. ${metal1} Conc`, value: recoveryMetal1 },
        { title: `%Recup. ${metal2} Conc`, value: recoveryMetal2 },
        { title: `Ratio ${metal1}`, value: ratioMetal1 },
        { title: `Ratio ${metal2}`, value: ratioMetal2 },
    ];
    return resultArray
...
const validationCon2meta2 = () => {
    return Yup.object().shape({
        ...
        con2Metal2conversion: Yup.string().required('El valor es obligatorio'),
