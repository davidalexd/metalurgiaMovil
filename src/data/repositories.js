export default {
    upcomingServices: [{
        topic: "Bomba Centrífuga",
        subtopic: "Calculos para equipos centrifugas",
        image_url: require('../assets/bombaCentrifuga.webp'),
    },{
        topic: "Celdas de Flotación",
        subtopic: "Calculos para celda de flotacion",
        image_url: require('../assets/celdasFlotacion.webp'),
    },{
        topic: "Simulacion de sofware",
        subtopic: "Calculos para simulacion de particulas",
        image_url: require('../assets/simulacion.webp'),
    },{
        topic: "Faja transportadora",
        subtopic: "Calculos para faja transportadora",
        image_url: require('../assets/fajaTransportadora.webp'),
    }],
    services: [
        {
            id: 1,
            ...
            calculations: [
                {
                    ...
                    metals: [{
                        ...
                        elements: [
                            ...
                            { id: 'con1Metal1f', name: 'valor Alimento del circuito 1', type: "input", span: 1 },
                            { id: 'con1-metal1-lb-unidades', name: 'Unidades', type: "label", span: 1 },
                            { id: 'con1Metal1conversion', name: 'Unidad', type: "select", span: 1, values: ['%', 'g/TM', 'Oz/TM', 'Oz/TC'] },
                            { id: 'con1-metal1-lb-producto', name: 'Producto', type: "label", span: 1 },
                            { id: 'con1Metal1metal', name: 'Metal', type: "select", span: 1, values: ['Cu', 'Pb', 'Zn', 'Al', 'Fe', 'Au', 'Ag', 'Sn', 'Mo'] },
                            { id: 'con1-metal1-lb-alimento', name: 'Alimento', type: "label", span: 1 },
                            { id: 'con1Metal1m1', name: 'valor Alimento 1', type: "input", span: 1 },
                            { id: 'con1-metal1-lb-concentrado', name: 'Concentrado del Metal', type: "label", span: 1 },
                            { id: 'con1Metal1m2', name: 'Valor Concentrado 1', type: "input", span: 1 },
                            { id: 'con1-metal1-lb-relave', name: 'Relave', type: "label", span: 1 },
                            { id: 'con1Metal1m3', name: 'Valor Relave 1', type: "input", span: 1 },
                        ],
                        resElements: [
                            { id: 'concentrado1meta1-resp-lb-tonelaje', name: `Tonelaje`, type: "label", span: 2 },
                            { id: 'concentrado1-meta1-resp-lb-concentrado', name: `Concentrado del metal (T/h)`, type: "label", span: 1 },
                            { id: 'concentrado1-meta1-resp-lbv-concentrado', name: 'concentrated value', type: "input", span: 1 },
                            { id: 'concentrado1-meta1-resp-lb-tailings', name: 'Relave (T/h)', type: "label", span: 1 },
                            { id: 'concentrado1-meta1-resp-lbv-tailings', name: 'tailings value', type: "input", span: 1 },
                            { id: 'concentrado1meta1-resp-lb-recuperaciones', name: `Recuperaciones`, type: "label", span: 2 },
                            { id: 'concentrado1-meta1-resp-lb-recovery', name: `%Recup. del metal`, type: "label", span: 1 },
                            { id: 'concentrado1-meta1-resp-lbv-recovery', name: 'recovery value', type: "input", span: 1 },
                            { id: 'concentrado1meta1-resp-lb-Ratio', name: `Ratio`, type: "label", span: 2 },
                            { id: 'concentrado1-meta1-resp-lb-concentrationRatio', name: `Ratio Concentración`, type: "label", span: 1 },
                            { id: 'concentrado1-meta1-resp-lbv-concentrationRatio', name: 'concentrationRatio value', type: "input", span: 1 },
                        ]
                    }]
                },
                {
        ...
        {
            id:2,
            topic: "Análisis Tamaño de Partícula",
            subtopic:"Calculos para el Análisis Tamaño de Partícula",
            number:3,
            operation:4,
            calculation:5,
        ...
        },
        {
            ...
            subtopic:"Calculos para el Balance de Masa",
            number:3,
            operation:4,
            calculation:5,
            ...
            image_url:require('../assets/img4.webp'),
            calculations:[],
        },
        {
            id:4,
            topic: "Dimensionamiento Equipos",
            subtopic:"Calculos para Dimensionamiento Equipos",
            number:3,
            operation:4,
            calculation:5,
            description:"Concentrate value is a crucial concept in metallurgy, especially in the context of mineral processing and ore beneficiation. Concentrate refers to the valuable portion of the ore that has been separated and concentrated from the gangue or waste material during the beneficiation process.",
        ...
        {
            id:5,
            topic: "Valorización concentrados",
            subtopic:"Calculos para Valorización concentrados",
            number:3,
            operation:4,
            calculation:5,
            description:"Concentrate value is a crucial concept in metallurgy, especially in the context of mineral processing and ore beneficiation. Concentrate refers to the valuable portion of the ore that has been separated and concentrated from the gangue or waste material during the beneficiation process.",
            image_url:require('../assets/img5.webp'),
            calculations:[],
        },
    ]
};
